...
declare -a module_list=("nose" "scipy" "numpy" "netCDF4" "affine" "pyyaml")
...
python setup.py develop
cd ..
echo "...bmi-tester installed"

# Install useful addons
conda install -y anaconda-client
conda install -y --channel https://conda.anaconda.org/blaze rednose
conda install -y coverage

# Instructions for installing a repo for development
echo "In order to develop a permamodel package, install it.  E.g.:"
echo "  Get and install permamodel..."
echo "    git clone https://github.com/permamodel/permamodel.git"
echo "    cd permamodel"
echo "    python setup.py develop"
echo "    cd .."

### SAMPLE repo installation ###
